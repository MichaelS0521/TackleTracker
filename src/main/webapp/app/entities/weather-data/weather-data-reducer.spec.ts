...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEATHERDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WEATHERDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WEATHERDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WEATHERDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WEATHERDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WEATHERDATA actions', async () => {
      const arg = 42666;
