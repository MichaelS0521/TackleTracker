...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bait-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BAITDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BAITDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BAITDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BAITDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BAITDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BAITDATA actions', async () => {
      const arg = 42666;
