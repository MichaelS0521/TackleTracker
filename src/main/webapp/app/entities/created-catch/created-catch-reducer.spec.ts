...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREATEDCATCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CREATEDCATCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CREATEDCATCH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CREATEDCATCH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CREATEDCATCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CREATEDCATCH actions', async () => {
      const arg = 42666;
