...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fish-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FISHDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FISHDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FISHDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FISHDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FISHDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FISHDATA actions', async () => {
      const arg = 42666;
